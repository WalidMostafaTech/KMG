        ...
        {service === "accounts" && (
          <>
            ...
            <div className="rounded-xl bg-input p-4 col-span-2">
              <p className="mb-3 text-sm font-medium">نطاق السعر</p>
            ...
            >
              <SelectTrigger className="rounded-full bg-input w-full col-span-1">
                <SelectValue placeholder="من الوقت" />
              </SelectTrigger>
              <SelectContent>
            ...
            >
              <SelectTrigger className="rounded-full bg-input w-full col-span-1">
                <SelectValue placeholder="الى الوقت" />
              </SelectTrigger>
              <SelectContent>
                {productsMinutesRange?.map((t) => (
                  <SelectItem key={t} value={t}>
  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-between text-sm text-muted-foreground">
        <span>من {value[0]}</span>
        <span>إلى {value[1]}</span>
      </div>
